...
*/
const Total = {computerScore: 0, playerScore:0}
...
function showResult(score, playerChoice, computerChoice) {
  ...
  if(score == -1){
    resultview.innerText = `You lose`
  }
  else if(score == 1){
    resultview.innerText = `You win`
  }
  else{
    resultview.innerText = `Draw`
  }
  handsdiv.innerText =`👱 ${playerChoice} vs 🤖 ${computerChoice} `
  playerscore.innerText= 'Your score: ' + Total["playerScore"]
}
